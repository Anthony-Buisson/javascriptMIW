...
function plus(n) {
    ...
    document.forms[0].quantity[n].value = document.forms[0].quantity[n].value*1 + 1;
}
function moins(n) {
...
function affMontant() {
    ...
    for (let i = 0; i < quantities.length; i++) {
        mtHT = mtHT*1 + (quantities[i].value*prices[i].value);
    }
...
function afficheForm() {
    let ch = '<form name="formulaireCommande">' +
        ...
        '    </fieldset><fieldset onclick="affMontant()">' +
